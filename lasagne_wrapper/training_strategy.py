...
from optimization_objectives import mean_categorical_crossentropy, mean_pixel_binary_crossentropy, \
                                    mean_pixel_categorical_crossentropy
from learn_rate_shedules import get_constant
from parameter_updates import get_update_adam
from batch_iterators import get_batch_iterator
...
class TrainingStrategy(object):
    ...
    def __init__(self, batch_size=100, ini_learning_rate=0.001, max_epochs=100, patience=10, y_tensor_type=T.ivector,
                 ...
                 best_model_by_accurary=False, debug_mode=False, layer_update_filter=None):
        """
        Constructor
        """
